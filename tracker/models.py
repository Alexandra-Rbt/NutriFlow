...
class FoodLog(models.Model):
    ...
    # Valori calculate automat la salvare
    ...
    def save(self, *args, **kwargs):
        # Calcul automat la fiecare salvare
...
class BodyWeight(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='weights', null = True, blank = True)
...
class Recipe(models.Model):
    ...
    # Valori totale (calculate din ingrediente)
